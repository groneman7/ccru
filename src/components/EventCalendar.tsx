...
export function EventCalendar({
    ...
    return (
      <div className="grid grid-cols-7">
        {["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"].map((day) => (
          <div key={day} className="text-md py-2 font-semibold">
            {day}
          </div>
        ))}
      </div>
      ...
      >
        <div
          className={cn(
            ...
            !date.isSame(selectedMonth, "month") &&
  ...
  return (
    <div className="flex flex-1 flex-col items-stretch justify-stretch border-2 border-red-500">
      <CalendarHeader />
      <CalendarGrid />
    </div>
  );
